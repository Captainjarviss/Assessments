# -*- coding: utf-8 -*-
"""lvadsusr71_arpit_lab3_clustering.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1yV4eX8k4j5Zu1N7FdktnxvxMI0thxS2j
"""
...
s_data=pd.read_csv("/content/seeds.csv")
...
for col in seeds_data.columns:
    ...
    seeds_data[col] = pd.to_numeric(seeds_data[col], errors='coerce')
